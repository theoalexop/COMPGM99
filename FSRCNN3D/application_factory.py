...
"""
Modification:
Addition of selection choices for FSRCNN3D and VDSR3D (see lines 81-83) in application_factory.py, 
...
SUPPORTED_NETWORK = {
    ...
    # addition of FSRCNN3D and VDSR3D
    "fsrcnn3dnet": 'niftynet.network.fsrcnn3dnet.FSRCNN3D',
    "vdsr3dnet": 'niftynet.network.vdsr3dnet.VDSR3D'
}
