...
# In the absence of pre-defined error maps, the uniform Uniform Sampler is utilized for the first 735 iterations in the case of HH (or, equivalently, first 5 epochs) and inference 
...
for max_iter in `seq 735 1470 148470`
do
